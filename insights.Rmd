...
```{r}
people <- tibble("pseudonym"=survey$pseudonym, "pseudonym_generator"=survey$pseudonym_generator, "sex"=survey$sex, "major"=survey$academic_major, "academic_level"=survey$academic_level, "year_born"=survey$year_born, "favorite_song"=survey$favorite_song)
```
